...
// Control panel with buttons for simulation interaction
public class ControlPanel {
    private final MapCanvas mapCanvas;
    private final SimulationWrapper sim;
    ...
    public ScrollPane createTrafficLightControls() {
        ...
        tlNextPhaseBtn.setOnAction(e -> setTLNextPhaseAll()); // set all TL to next phase by function in
